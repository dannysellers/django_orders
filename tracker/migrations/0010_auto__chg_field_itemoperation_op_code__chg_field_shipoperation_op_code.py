...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemOperation.op_code'
        db.alter_column(u'tracker_itemoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'ShipOperation.op_code'
        db.alter_column(u'tracker_shipoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'WorkOrderOperation.op_code'
        db.alter_column(u'tracker_workorderoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'ItemOperation.op_code'
        db.alter_column(u'tracker_itemoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'ShipOperation.op_code'
        db.alter_column(u'tracker_shipoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'WorkOrderOperation.op_code'
        db.alter_column(u'tracker_workorderoperation', 'op_code', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'tracker.workorder': {
            ...
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workorder'", 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
        ...
        u'tracker.workorderauditlogentry': {
            ...
            'photo_inspection': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '4'}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_workorder'", 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
            'tracking': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
