...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkOrderOperation'
        db.create_table(u'tracker_workorderoperation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('audit_log.models.fields.CreatingUserField')(related_name=u'created_tracker_workorderoperation_set', to=orm['auth.User'])),
            ('created_with_session_key', self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True)),
            ('modified_by', self.gf('audit_log.models.fields.LastUserField')(related_name=u'modified_tracker_workorderoperation_set', to=orm['auth.User'])),
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operations', to=orm['tracker.WorkOrder'])),
        ))
        db.send_create_signal(u'tracker', ['WorkOrderOperation'])


    def backwards(self, orm):
        # Deleting model 'WorkOrderOperation'
        db.delete_table(u'tracker_workorderoperation')
