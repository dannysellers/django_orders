...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrderAuditLogEntry.shipment'
        db.alter_column(u'tracker_workorderauditlogentry', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Shipment'], null=True))

        # Changing field 'WorkOrder.shipment'
        db.alter_column(u'tracker_workorder', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Shipment'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WorkOrderAuditLogEntry.shipment'
        raise RuntimeError("Cannot reverse this migration. 'WorkOrderAuditLogEntry.shipment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkOrderAuditLogEntry.shipment'
        db.alter_column(u'tracker_workorderauditlogentry', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Shipment']))

        # User chose to not deal with backwards NULL issues for 'WorkOrder.shipment'
        raise RuntimeError("Cannot reverse this migration. 'WorkOrder.shipment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkOrder.shipment'
        db.alter_column(u'tracker_workorder', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Shipment']))
    ...
    models = {
        ...
        u'tracker.workorder': {
            ...
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tracker.Shipment']", 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '1'}),
