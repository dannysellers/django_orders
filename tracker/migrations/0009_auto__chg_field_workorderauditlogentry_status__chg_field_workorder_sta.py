...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrderAuditLogEntry.status'
        db.alter_column(u'tracker_workorderauditlogentry', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'WorkOrder.status'
        db.alter_column(u'tracker_workorder', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'WorkOrderAuditLogEntry.status'
        db.alter_column(u'tracker_workorderauditlogentry', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'WorkOrder.status'
        db.alter_column(u'tracker_workorder', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))
