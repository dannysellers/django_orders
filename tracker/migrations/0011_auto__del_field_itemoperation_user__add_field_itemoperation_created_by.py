...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemOperation.user'
        db.delete_column(u'tracker_itemoperation', 'user_id')

        # Adding field 'ItemOperation.created_by'
        db.add_column(u'tracker_itemoperation', 'created_by',
                      self.gf('audit_log.models.fields.CreatingUserField')(related_name=u'created_tracker_itemoperation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ItemOperation.created_with_session_key'
        db.add_column(u'tracker_itemoperation', 'created_with_session_key',
                      self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'ItemOperation.modified_by'
        db.add_column(u'tracker_itemoperation', 'modified_by',
                      self.gf('audit_log.models.fields.LastUserField')(related_name=u'modified_tracker_itemoperation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ItemOperation.modified_with_session_key'
        db.add_column(u'tracker_itemoperation', 'modified_with_session_key',
                      self.gf('audit_log.models.fields.LastSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Deleting field 'ShipOperation.user'
        db.delete_column(u'tracker_shipoperation', 'user_id')

        # Adding field 'ShipOperation.created_by'
        db.add_column(u'tracker_shipoperation', 'created_by',
                      self.gf('audit_log.models.fields.CreatingUserField')(related_name=u'created_tracker_shipoperation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ShipOperation.created_with_session_key'
        db.add_column(u'tracker_shipoperation', 'created_with_session_key',
                      self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'ShipOperation.modified_by'
        db.add_column(u'tracker_shipoperation', 'modified_by',
                      self.gf('audit_log.models.fields.LastUserField')(related_name=u'modified_tracker_shipoperation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ShipOperation.modified_with_session_key'
        db.add_column(u'tracker_shipoperation', 'modified_with_session_key',
                      self.gf('audit_log.models.fields.LastSessionKeyField')(max_length=40, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ItemOperation.user'
        db.add_column(u'tracker_itemoperation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'ItemOperation.created_by'
        db.delete_column(u'tracker_itemoperation', 'created_by_id')

        # Deleting field 'ItemOperation.created_with_session_key'
        db.delete_column(u'tracker_itemoperation', 'created_with_session_key')

        # Deleting field 'ItemOperation.modified_by'
        db.delete_column(u'tracker_itemoperation', 'modified_by_id')

        # Deleting field 'ItemOperation.modified_with_session_key'
        db.delete_column(u'tracker_itemoperation', 'modified_with_session_key')

        # Adding field 'ShipOperation.user'
        db.add_column(u'tracker_shipoperation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'ShipOperation.created_by'
        db.delete_column(u'tracker_shipoperation', 'created_by_id')

        # Deleting field 'ShipOperation.created_with_session_key'
        db.delete_column(u'tracker_shipoperation', 'created_with_session_key')

        # Deleting field 'ShipOperation.modified_by'
        db.delete_column(u'tracker_shipoperation', 'modified_by_id')

        # Deleting field 'ShipOperation.modified_with_session_key'
        db.delete_column(u'tracker_shipoperation', 'modified_with_session_key')
