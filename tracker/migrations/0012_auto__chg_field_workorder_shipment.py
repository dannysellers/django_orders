...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tracker_workorder', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['tracker.Shipment']))
    ...
    models = {
        ...
        u'tracker.workorder': {
            ...
            'created_with_session_key': ('audit_log.models.fields.CreatingSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'createdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 26, 0, 0)'}),
            ...
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_workorder'", 'unique': 'True', 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
        ...
        u'tracker.workorderauditlogentry': {
            ...
            'photo_inspection': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '4'}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'_auditlog__workorder'", 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
            'tracking': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
