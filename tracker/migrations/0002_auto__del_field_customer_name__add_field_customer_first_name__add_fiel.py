...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tracker_customer', 'name')

        # Adding field 'Customer.first_name'
        db.add_column(u'tracker_customer', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='Older', max_length=128),
                      keep_default=False)

        # Adding field 'Customer.last_name'
        db.add_column(u'tracker_customer', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='Customer', max_length=128),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Customer.name'
        db.add_column(u'tracker_customer', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=128),
                      keep_default=False)

        # Deleting field 'Customer.first_name'
        db.delete_column(u'tracker_customer', 'first_name')

        # Deleting field 'Customer.last_name'
        db.delete_column(u'tracker_customer', 'last_name')
