...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrderAuditLogEntry.finishdate'
        db.alter_column(u'tracker_workorderauditlogentry', 'finishdate', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WorkOrderAuditLogEntry.createdate'
        db.alter_column(u'tracker_workorderauditlogentry', 'createdate', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'WorkOrder.finishdate'
        db.alter_column(u'tracker_workorder', 'finishdate', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WorkOrder.shipment'
        db.alter_column(u'tracker_workorder', 'shipment_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['tracker.Shipment']))
        # Adding unique constraint on 'WorkOrder', fields ['shipment']
        db.create_unique(u'tracker_workorder', ['shipment_id'])


        # Changing field 'WorkOrder.createdate'
        db.alter_column(u'tracker_workorder', 'createdate', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Removing unique constraint on 'WorkOrder', fields ['shipment']
        db.delete_unique(u'tracker_workorder', ['shipment_id'])


        # Changing field 'WorkOrderAuditLogEntry.finishdate'
        db.alter_column(u'tracker_workorderauditlogentry', 'finishdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'WorkOrderAuditLogEntry.createdate'
        db.alter_column(u'tracker_workorderauditlogentry', 'createdate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'WorkOrder.finishdate'
        db.alter_column(u'tracker_workorder', 'finishdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'WorkOrder.shipment'
        db.alter_column(u'tracker_workorder', 'shipment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.Shipment']))

        # Changing field 'WorkOrder.createdate'
        db.alter_column(u'tracker_workorder', 'createdate', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'tracker.itemoperation': {
            ...
            'modified_with_session_key': ('audit_log.models.fields.LastSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'op_code': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'})
        },
        u'tracker.optextras': {
        ...
        u'tracker.workorder': {
            ...
            'created_with_session_key': ('audit_log.models.fields.CreatingSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'createdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 21, 0, 0)'}),
            'custom_boxing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'finishdate': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'modified_with_session_key': ('audit_log.models.fields.LastSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workorders'", 'to': u"orm['tracker.Customer']"}),
            ...
            'shipment': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'workorder'", 'unique': 'True', 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
        ...
        u'tracker.workorderauditlogentry': {
            ...
            'modified_with_session_key': ('audit_log.models.fields.LastSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_workorders'", 'to': u"orm['tracker.Customer']"}),
            'palletizing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'photo_inspection': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '4'}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'_auditlog_workorder'", 'null': 'True', 'to': u"orm['tracker.Shipment']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
            'tracking': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'tracker.workorderoperation': {
            'Meta': {'object_name': 'WorkOrderOperation'},
            'created_by': ('audit_log.models.fields.CreatingUserField', [], {'related_name': "u'created_tracker_workorderoperation_set'", 'to': u"orm['auth.User']"}),
            'created_with_session_key': ('audit_log.models.fields.CreatingSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'dt': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_by': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'modified_tracker_workorderoperation_set'", 'to': u"orm['auth.User']"}),
            'modified_with_session_key': ('audit_log.models.fields.LastSessionKeyField', [], {'max_length': '40', 'null': 'True'}),
            'op_code': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operations'", 'to': u"orm['tracker.WorkOrder']"})
        }
    }
